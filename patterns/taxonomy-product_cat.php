 ...
 */
?>
<!-- wp:template-part {"slug":"header","theme":"esotericism"} /-->
...
<main class="wp-block-group page__wrapper"><!-- wp:group {"align":"full","className":"header-woocommerce-category","layout":{"type":"constrained"}} -->
    ...
    <div class="wp-block-columns alignwide products__cols"><!-- wp:column {"width":"","className":"products__col products__col\u002d\u002dfilter"} -->
        <div class="wp-block-column products__col products__col--filter"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"filter-sections__close-button"} -->
            <figure class="wp-block-image size-large filter-sections__close-button"><img src="http://quantumezoterik.com/wp-content/themes/esotericism/assets/images/close-button.svg" alt=""/></figure>
            <!-- /wp:image -->
            ...
            <div class="wp-block-group filter-sections__container"><!-- wp:group {"className":"filter-sections filter-sections\u002d\u002dcategories filter-sections\u002d\u002ddark-panel animated backInUp","layout":{"type":"constrained"}} -->
                <div class="wp-block-group filter-sections filter-sections--categories filter-sections--dark-panel animated backInUp"><!-- wp:heading {"level":6} -->
                    <h6 class="wp-block-heading">Підкатегорії</h6>
                    <!-- /wp:heading -->

                    <!-- wp:woocommerce/product-categories {"hasEmpty":true} /--></div>
                <!-- /wp:group -->

                <!-- wp:woocommerce/filter-wrapper {"filterType":"attribute-filter","heading":"Фільтрувати за атрибутом","className":"filter-sections filter-sections\u002d\u002ddark-panel animated backInUp"} -->
                <div class="wp-block-woocommerce-filter-wrapper filter-sections filter-sections--dark-panel animated backInUp"><!-- wp:heading {"level":6} -->
                    <h6 class="wp-block-heading">Розмір</h6>
                    <!-- /wp:heading -->

                    <!-- wp:woocommerce/attribute-filter {"attributeId":2,"showCounts":true,"queryType":"and","heading":"","lock":{"remove":true}} -->
                ...
                <!-- wp:woocommerce/filter-wrapper {"filterType":"attribute-filter","heading":"Фільтрувати за атрибутом","className":"filter-sections filter-sections\u002d\u002ddark-panel animated backInUp"} -->
                <div class="wp-block-woocommerce-filter-wrapper filter-sections filter-sections--dark-panel animated backInUp"><!-- wp:heading {"level":6} -->
                    <h6 class="wp-block-heading">Призначення</h6>
                    <!-- /wp:heading -->

                    <!-- wp:woocommerce/attribute-filter {"attributeId":1,"showCounts":true,"queryType":"and","heading":"","lock":{"remove":true}} -->
                    <div class="wp-block-woocommerce-attribute-filter is-loading"></div>
                    <!-- /wp:woocommerce/attribute-filter --></div>
                <!-- /wp:woocommerce/filter-wrapper -->

                <!-- wp:woocommerce/filter-wrapper {"filterType":"price-filter","heading":"Фільтрувати за ціною","className":"filter-sections filter-sections\u002d\u002ddark-panel animated backInUp"} -->
                <div class="wp-block-woocommerce-filter-wrapper filter-sections filter-sections--dark-panel animated backInUp"><!-- wp:heading {"level":6} -->
                    <h6 class="wp-block-heading">Ціна</h6>
                    <!-- /wp:heading -->
                ...
                <!-- wp:woocommerce/filter-wrapper {"filterType":"active-filters","heading":"Активні фільтри","className":"filter-sections filter-sections\u002d\u002ddark-panel animated backInUp"} -->
                <div class="wp-block-woocommerce-filter-wrapper filter-sections filter-sections--dark-panel animated backInUp"><!-- wp:heading {"level":6} -->
                    <h6 class="wp-block-heading">Активні фільтри</h6>
                    <!-- /wp:heading -->
        ...
        <div class="wp-block-column products-col products__col--products-container"><!-- wp:woocommerce/store-notices /-->
            ...
            <!-- wp:woocommerce/product-categories {"hasCount":false,"hasImage":true,"hasEmpty":true,"isHierarchical":false,"showChildrenOnly":true,"className":"section-categories-grid"} /-->

            <!-- wp:group {"className":"top-section","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
            <div class="wp-block-group top-section"><!-- wp:group {"className":"sort-section","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
                ...
                <div class="wp-block-buttons buttons-section"><!-- wp:button {"className":"filters__button"} -->
                    <div class="wp-block-button filters__button"><a class="wp-block-button__link wp-element-button" rel="#">Фільтри</a></div>
                    <!-- /wp:button --></div>
                <!-- /wp:buttons --></div>
            <!-- /wp:group -->

            <!-- wp:woocommerce/product-collection {"queryId":6,"query":{"woocommerceAttributes":[],"woocommerceStockStatus":["instock","outofstock","onbackorder"],"taxQuery":[],"isProductCollectionBlock":true,"perPage":9,"pages":0,"offset":0,"postType":"product","order":"asc","orderBy":"title","author":"","search":"","exclude":[],"sticky":"","inherit":true,"featured":false,"woocommerceOnSale":false,"woocommerceHandPickedProducts":[],"filterable":false},"tagName":"div","displayLayout":{"type":"flex","columns":3,"shrinkColumns":true},"queryContextIncludes":["collection"],"forcePageReload":true,"__privatePreviewState":{"isPreview":true,"previewMessage":"Фактичні товари можуть відрізнятися в залежності від сторінки, яку ви переглядаєте."},"align":"wide","layout":{"type":"constrained"}} -->
            <div class="wp-block-woocommerce-product-collection alignwide"><!-- wp:woocommerce/product-template -->
                ...
                <!-- wp:acf/no-products-found {"name":"acf/no-products-found","mode":"preview"} /-->
    ...
    <div class="wp-block-group alignfull section-group section-products-carousel animated fadeIn has-base-2-background-color has-background"><!-- wp:group {"className":"section-group__header","layout":{"type":"constrained"}} -->
        <div class="wp-block-group section-group__header"><!-- wp:heading {"textAlign":"center","className":"has-bottom-line"} -->
            <h2 class="wp-block-heading has-text-align-center has-bottom-line">Нові надходження</h2>
            <!-- /wp:heading --></div>
        <!-- /wp:group -->
...
<!-- wp:template-part {"slug":"footer","theme":"esotericism"} /-->